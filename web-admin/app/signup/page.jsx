...
export default function Home() {
  ...
  const submit = () => {
    if (!form.companyDomain || !form.username || !form.password || !form.confirmPassword){
      return
    }
    if (! /^[a-zA-Z]{1,9}\.[a-zA-Z]{1,9}\.[a-zA-Z]{1,9}$/.test(form.companyDomain)) {
      window.alert("The company domain is not valid, it should be <1-9 charcters>.<1-9 charcters>.<1-9 charcters> such as 'aaa.bbb.ccc'");
      return;
    }
    ...
    if  (form.password.length < 8) {
      window.alert('The password needs to have at least 8 characters!');
      return
    }
        ...
        <div className="flex w-[50%] items-center justify-center bg-[#2B709B] rounded-lg">
          <div className="w-[75%] flex flex-col items-center">
            ...
            <div className="flex w-full bg-[#1d4964] h-[100%] justify-center rounded-2xl">
              <div className="w-[80%] px-5 py-[25px]">
