          ...
          <div className="flex w-[50%] items-center justify-center bg-[#2B709B] rounded-lg">
            <div className="w-[75%] flex flex-col items-center">
              ...
              <div className="flex w-full bg-[#1d4964] h-[100%] justify-center rounded-2xl">
                <form className="w-[80%] px-5 py-[30px]">
                  ...
                  <button type="submit" className="w-full bg-[#047eb3] text-white py-2 px-4 rounded-md shadow-sm hover:bg-[#047eb37e] font-mono mt-4">Sign Up</button>
