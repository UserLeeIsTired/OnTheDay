...
CREATE TABLE otd_domain_owner (
    ...
    company_domain TEXT CHECK (company_domain ~ '^[a-zA-Z]{1,9}\.[a-zA-Z]{1,9}\.[a-zA-Z]{1,9}$') UNIQUE,
...
SELECT uid, company_domain, owner_username, created_at FROM otd_domain_owner
